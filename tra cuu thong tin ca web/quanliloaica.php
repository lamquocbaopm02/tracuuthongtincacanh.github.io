  ...
  <div class="sixteen columns">			
		...
		<div class="login-screen">
			...
			<div class="login-form">
				...
				<a class="btn btn-primary btn-large btn-block" href="themloaica.php">Thêm Mới</a>
			</div>
		</div>
	</div></th>
    ...
    $row_danhmuc = $conn->query($sql_danhmuc);
        while($row = $row_danhmuc->fetch_assoc()){
            ...
            echo "<td>$ten</td>";
            echo "</td>";
            echo "<td><a href='xoaquanliloaica.php?Id=$id' title='BCDONLINE CONFIRM YES/NO' onclick='return confirmAction() '>Xóa  |</a>";
            echo "<a href='suaquanliloaica.php?Id=$id'>Sửa </a></td></tr>";
    }
